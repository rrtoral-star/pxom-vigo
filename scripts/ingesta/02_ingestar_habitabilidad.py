"""
Script de Ingesta Habitabilidad Galicia v1.0

Pipeline completo:
1. Cargar JSON de la normativa de habitabilidad
...
5. Indexar en Qdrant (colección separada)

Uso:
    python 02_ingestar_habitabilidad.py
    python 02_ingestar_habitabilidad.py --sin-llm  # Sin Groq, solo keywords locales
    python 02_ingestar_habitabilidad.py --test     # Solo 10 chunks para probar
"""
...
CONFIG = {
    # Paths
    "JSON_PATH": "C:/PROY/pxom-solo/data/cleaned/normativa_habitabilidad_galicia_2010.json",
    "QDRANT_PATH": "C:/PROY/pxom-solo/data/rag/qdrant_v2",

    # Qdrant - colección separada
    "COLLECTION_NAME": "habitabilidad_galicia_2010",
    "VECTOR_SIZE": 1024,
...
def main(args):
    ...
    print("\n" + "="*70)
    print("INGESTA HABITABILIDAD GALICIA v1.0")
    ...
    chunker = ChunkerPXOM(CONFIG["JSON_PATH"])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingesta Habitabilidad Galicia v1.0")
